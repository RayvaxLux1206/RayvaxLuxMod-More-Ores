...
import rvl.more_ores.item.special_item.ToxicBlockItem;
...
public class ModBlocks {
    ...
    public static Block TOXIC_BRONZE_BLOCK;
    public static Block ALLOY_TOXIC_BRONZE_BLOCK;
    ...
    private static final Holder<MobEffect> effect1 = MobEffects.POISON;
    private static final Holder<MobEffect> effect2 = MobEffects.WITHER;
     ...
     public static void registerModBlocks() {
         DEEPSLATE_ALUMINIUM_ORE = registerBlocks("deepslate_aluminium_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_aluminium_ore")));
         ALUMINIUM_ORE = registerBlocks("aluminium_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "aluminium_ore")));
        ...
        //Tin Blocks
         DEEPSLATE_TIN_ORE = registerBlocks("deepslate_tin_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_tin_ore")));
         TIN_ORE = registerBlocks("tin_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "tin_ore")));
        ...
        //Alloy Blocks -Bronze -Copper
         ...
         TOXIC_BRONZE_BLOCK = registerToxicBlocks("toxic_bronze_block",
                 new ToxicMineralBlock(mineableSetting(Blocks.IRON_BLOCK, 4f, "toxic_bronze_block"), effect1), effect1);
         ALLOY_TOXIC_BRONZE_BLOCK = registerToxicBlocks("alloy_toxic_bronze_block",
                 new ToxicMineralBlock(mineableSetting(Blocks.IRON_BLOCK, 4f, "alloy_bronze_block"), effect1), effect1);
        ...
        //Chrome Blocks
         DEEPSLATE_CHROME_ORE = registerBlocks("deepslate_chrome_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_chrome_ore")));
         CHROME_ORE = registerBlocks("chrome_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "chrome_ore")));
        ...
        //Nikel Blocks
         DEEPSLATE_NICKEL_ORE = registerBlocks("deepslate_nickel_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_nickel_ore")));
         NICKEL_ORE = registerBlocks("nickel_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "nickel_ore")));
        ...
        //Plomb Blocks
         DEEPSLATE_PLOMB_ORE = registerBlocks("deepslate_plomb_ore",
                new XpDropToxicBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_plomb_ore"), effect2));
         PLOMB_ORE = registerBlocks("plomb_ore",
                new XpDropToxicBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "plomb_ore"), effect2));

         PLOMB_BLOCK = registerToxicBlocks("plomb_block",
                new ToxicMineralBlock(mineableSetting(Blocks.IRON_BLOCK, 4f, "plomb_block"), effect2), effect2);
         PLOMB_ORE_BLOCK = registerToxicBlocks("plomb_ore_block",
                new ToxicMineralBlock(mineableSetting(Blocks.STONE, 4f, "plomb_ore_block"), effect2), effect2);

        //Silicon Blocks
         DEEPSLATE_SILICON_ORE = registerBlocks("deepslate_silicon_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_silicon_ore")));
         SILICON_ORE = registerBlocks("silicon_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "silicon_ore")));
        ...
        //Silver Blocks
         DEEPSLATE_SILVER_ORE = registerBlocks("deepslate_silver_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_silver_ore")));
         SILVER_ORE = registerBlocks("silver_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "silver_ore")));
        ...
        //Titanium Blocks
         DEEPSLATE_TITANIUM_ORE = registerBlocks("deepslate_titanium_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_titanium_ore")));
         TITANIUM_ORE = registerBlocks("titanium_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "titanium_ore")));
        ...
        //Zinc Blocks
         DEEPSLATE_ZINC_ORE = registerBlocks("deepslate_zinc_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_zinc_ore")));
         ZINC_ORE = registerBlocks("zinc_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "zinc_ore")));
        ...
        //Other Ores
         DEEPSLATE_SALT_ORE = registerBlocks("deepslate_salt_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_salt_ore")));
         SALT_ORE = registerBlocks("salt_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "salt_ore")));
         SALT_BLOCK = registerBlocks("salt_block",
                new Block(mineableSetting(Blocks.STONE, 4f, "salt_block")));
         SODIUM_BLOCK = registerAlcalineBlocks("sodium_block",
                new AlcalineBlock(mineableSetting(Blocks.IRON_BLOCK, 4f, "sodium_block")));


         DEEPSLATE_ARSENIC_ORE = registerBlocks("deepslate_arsenic_ore",
                new XpDropToxicBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_arsenic_ore"), effect1));
         ARSENIC_ORE = registerBlocks("arsenic_ore",
                new XpDropToxicBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "arsenic_ore"), effect1));
         ARSENIC_BLOCK = registerToxicBlocks("arsenic_block",
                new ToxicMineralBlock(mineableSetting(Blocks.IRON_BLOCK, 4f, "arsenic_block"), effect1), effect1);


         DEEPSLATE_LITHIUM_ORE = registerBlocks("deepslate_lithium_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_lithium_ore")));
         LITHIUM_ORE = registerBlocks("lithium_ore",
                new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.STONE, 2f, "lithium_ore")));
         LITHIUM_ORE_BLOCK = registerBlocks("lithium_ore_block",
                new Block(mineableSetting(Blocks.STONE, 4f, "lithium_ore_block")));
         LITHIUM_BLOCK = registerAlcalineBlocks("lithium_block",
                new AlcalineBlock(mineableSetting(Blocks.IRON_BLOCK, 4f, "lithium_block")));

         //Volcanite
         BLACKSTONE_VOLCANITE_ORE = registerOtherWorldBlocks("blackstone_volcanite_ore",
                 new DropExperienceBlock(UniformInt.of(2,4), mineableSetting(Blocks.BASALT, 2f, "blackstone_volcanite_ore")));
         BASALT_VOLCANITE_ORE = registerOtherWorldBlocks("basalt_volcanite_ore",
                 new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.BLACKSTONE, 2f, "basalt_volcanite_ore")));
         VOLCANITE_ORE_BLOCK = registerOtherWorldBlocks("volcanite_ore_block",
                 new Block(mineableSetting(Blocks.STONE, 4f, "volcanite_ore_block")));
         VOLCANITE_BLOCK = registerOtherWorldBlocks("volcanite_block",
                 new Block(mineableSetting(Blocks.IRON_BLOCK, 4f, "volcanite_block")));

         //Soulrite
         SOUL_SAND_SOULRITE_ORE = registerOtherWorldBlocks("soul_sand_soulrite_ore",
                 new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.SOUL_SAND, 2f, "soul_sand_soulrite_ore")));
         SOUL_SOIL_SOULRITE_ORE = registerOtherWorldBlocks("soul_soil_soulrite_ore",
                 new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.SOUL_SOIL, 2f, "soul_soil_soulrite_ore")));
         SOULRITE_ORE_BLOCK = registerOtherWorldBlocks("soulrite_ore_block",
                 new Block(mineableSetting(Blocks.STONE, 4f, "soulrite_ore_block")));
         SOULRITE_BLOCK = registerOtherWorldBlocks("soulrite_block",
                 new Block(mineableSetting(Blocks.IRON_BLOCK, 4f, "soulrite_block")));

         //Racknite
         RACKNITE_ORE = registerOtherWorldBlocks("racknite_ore",
                 new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.NETHERRACK, 2f, "racknite_ore")));
         RACKNITE_ORE_BLOCK = registerOtherWorldBlocks("racknite_ore_block",
                 new Block(mineableSetting(Blocks.STONE, 4f, "racknite_ore_block")));
         RACKNITE_BLOCK = registerOtherWorldBlocks("racknite_block",
                 new Block(mineableSetting(Blocks.IRON_BLOCK, 4f, "racknite_block")));

         //Enderite
         ENDERITE_ORE = registerOtherWorldBlocks("enderite_ore",
                 new DropExperienceBlock(UniformInt.of(2, 4), mineableSetting(Blocks.END_STONE, 2f, "enderite_ore")));
         ENDERITE_ORE_BLOCK = registerOtherWorldBlocks("enderite_ore_block",
                 new Block(mineableSetting(Blocks.STONE, 4f, "enderite_ore_block")));
         ENDERITE_BLOCK = registerOtherWorldBlocks("enderite_block",
                 new Block(mineableSetting(Blocks.IRON_BLOCK, 4f, "enderite_block")));
    }
    private static Block registerBlocks(String name, Block block) {
        Registry.register(BuiltInRegistries.BLOCK, MoreOres.id(name),block);
        return Registry.register(BuiltInRegistries.ITEM, MoreOres.id(name),
                new BlockItem(block, new Item.Properties().setId(itemKey(name)))).getBlock();
    }

    private static Block registerToxicBlocks(String name, Block block, Holder<MobEffect> effect) {
        Registry.register(BuiltInRegistries.BLOCK, MoreOres.id(name),block);
        return Registry.register(BuiltInRegistries.ITEM, ResourceKey.create(Registries.ITEM, MoreOres.id(name)),
                new ToxicBlockItem(block, new Item.Properties().setId(itemKey(name)), effect, 10)).getBlock();
    }

    private static Block registerAlcalineBlocks(String name, Block block) {
        Registry.register(BuiltInRegistries.BLOCK, MoreOres.id(name),block);
        return Registry.register(BuiltInRegistries.ITEM, ResourceKey.create(Registries.ITEM, MoreOres.id(name)),
                new AlcalineBlockItem(block, new Item.Properties().setId(itemKey(name)))).getBlock();
    }

    private static Block registerOtherWorldBlocks(String name, Block block) {
        Registry.register(BuiltInRegistries.BLOCK, MoreOres.id(name),block);
        return Registry.register(BuiltInRegistries.ITEM, ResourceKey.create(Registries.ITEM, MoreOres.id(name)),
                new BlockItem(block, new Item.Properties().fireResistant().setId(itemKey(name)))).getBlock();
    }
    
    public static BlockBehaviour.Properties mineableSetting(Block block, float strength, String idKey) {
         return BlockBehaviour.Properties.ofFullCopy(block).strength(strength).requiresCorrectToolForDrops().setId(blockKey(idKey));
    }

    private static ResourceKey<Block> blockKey(String key) {
         return ResourceKey.create(Registries.BLOCK, MoreOres.id(key));
    }
