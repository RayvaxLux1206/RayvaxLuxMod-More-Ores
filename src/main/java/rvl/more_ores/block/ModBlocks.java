...
public class ModBlocks {
    ...
    private static final StatusEffect effect2 = StatusEffects.WITHER;
     ...
     public static void registerModBlocks() {
         DEEPSLATE_ALUMINIUM_ORE = registerBlocks("deepslate_aluminium_ore",
                new ExperienceDroppingBlock(AbstractBlock.Settings.copy(Blocks.STONE).strength(2.0f).requiresTool()));
        ...
        //Alloy Blocks -Bronze -Copper
         ...
         TOXIC_BRONZE_BLOCK = registerToxicBlocks("toxic_bronze_block",
                 new ToxicMineralBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(4.0f).requiresTool(), effect1), effect1);
        ...
        //Plomb Blocks
         DEEPSLATE_PLOMB_ORE = registerBlocks("deepslate_plomb_ore",
                new XpDropToxicBlock(AbstractBlock.Settings.copy(Blocks.STONE).strength(2.0f).requiresTool(), effect2));
         PLOMB_ORE = registerBlocks("plomb_ore",
                new XpDropToxicBlock(AbstractBlock.Settings.copy(Blocks.STONE).strength(2.0f).requiresTool(), effect2));
         PLOMB_BLOCK = registerToxicBlocks("plomb_block",
                new ToxicMineralBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(4.0f).requiresTool(), effect2), effect2);

         PLOMB_ORE_BLOCK = registerToxicBlocks("plomb_ore_block",
                new ToxicMineralBlock(AbstractBlock.Settings.copy(Blocks.STONE).strength(4.0f).requiresTool(), effect2), effect2);
        ...
        //Other Ores
         ...
         SODIUM_BLOCK = registerAlcalineBlocks("sodium_block",
                new AlcalineBlock(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(4.0f).requiresTool()));


         DEEPSLATE_ARSENIC_ORE = registerBlocks("deepslate_arsenic_ore",
                new XpDropToxicBlock(AbstractBlock.Settings.copy(Blocks.STONE).strength(2.0f).requiresTool(), effect1));
         ...
         BLACKSTONE_VOLCANITE_ORE = registerOtherWorldBlocks("blackstone_volcanite_ore",
                 new Block(AbstractBlock.Settings.copy(Blocks.BASALT).strength(2.0f).requiresTool()));
         BASALT_VOLCANITE_ORE = registerOtherWorldBlocks("basalt_volcanite_ore",
                 new Block(AbstractBlock.Settings.copy(Blocks.BLACKSTONE).strength(2.0f).requiresTool()));
         ...
         SOUL_SAND_SOULRITE_ORE = registerOtherWorldBlocks("soul_sand_soulrite_ore",
                 new Block(AbstractBlock.Settings.copy(Blocks.SOUL_SAND).strength(2.0f).requiresTool()));
         SOUL_SOIL_SOULRITE_ORE = registerOtherWorldBlocks("soul_soil_soulrite_ore",
                 new Block(AbstractBlock.Settings.copy(Blocks.SOUL_SOIL).strength(2.0f).requiresTool()));
         ...
         RACKNITE_ORE = registerOtherWorldBlocks("racknite_ore",
                 new Block(AbstractBlock.Settings.copy(Blocks.NETHERRACK).strength(2.0f).requiresTool()));
         ...
         ENDERITE_ORE = registerOtherWorldBlocks("enderite_ore",
                 new Block(AbstractBlock.Settings.copy(Blocks.END_STONE).strength(2.0f).requiresTool()));
    ...
    private static Block registerBlocks(String name, Block block) {
        Registry.register(Registries.BLOCK, new Identifier(MoreOres.MODID, name),block);
        return Registry.register(Registries.ITEM, new Identifier(MoreOres.MODID, name),
                new BlockItem(block, new Item.Settings())).getBlock();
    }

    private static Block registerToxicBlocks(String name, Block block, StatusEffect effect) {
        Registry.register(Registries.BLOCK, new Identifier(MoreOres.MODID, name),block);
        return Registry.register(Registries.ITEM, new Identifier(MoreOres.MODID, name),
                new ToxicBlockItem(block, new Item.Settings(), effect, 10)).getBlock();
    }

    private static Block registerAlcalineBlocks(String name, Block block) {
        Registry.register(Registries.BLOCK, new Identifier(MoreOres.MODID, name),block);
        return Registry.register(Registries.ITEM, new Identifier(MoreOres.MODID, name),
                new AlcalineBlockItem(block, new Item.Settings())).getBlock();
    }

    private static Block registerOtherWorldBlocks(String name, Block block) {
        Registry.register(Registries.BLOCK, new Identifier(MoreOres.MODID, name),block);
        return Registry.register(Registries.ITEM, new Identifier(MoreOres.MODID, name),
                new BlockItem(block, new Item.Settings().fireproof())).getBlock();
    }
