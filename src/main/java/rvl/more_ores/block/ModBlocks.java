...
public class ModBlocks {
     ...
     public static void registerModBlocks() {
        ...
        //Plomb Blocks
         DEEPSLATE_PLOMB_ORE = registerBlocks("deepslate_plomb_ore",
                new XpDropToxicBlock(UniformIntProvider.create(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_plomb_ore"), effect2));
         PLOMB_ORE = registerBlocks("plomb_ore",
                new XpDropToxicBlock(UniformIntProvider.create(2, 4), mineableSetting(Blocks.STONE, 2f, "plomb_ore"), effect2));
        ...
        //Other Ores
         ...
         DEEPSLATE_ARSENIC_ORE = registerBlocks("deepslate_arsenic_ore",
                new XpDropToxicBlock(UniformIntProvider.create(2, 4), mineableSetting(Blocks.DEEPSLATE, 2f, "deepslate_arsenic_ore"), effect1));
         ARSENIC_ORE = registerBlocks("arsenic_ore",
                new XpDropToxicBlock(UniformIntProvider.create(2, 4), mineableSetting(Blocks.STONE, 2f, "arsenic_ore"), effect1));
    ...
    private static Block registerBlocks(String name, Block block) {
        Registry.register(Registries.BLOCK, MoreOres.id(name),block);
        return Registry.register(Registries.ITEM, MoreOres.id(name),
                new BlockItem(block, ModItems.normalSettings(name))).getBlock();
    }

    private static Block registerToxicBlocks(String name, Block block, RegistryEntry<StatusEffect> effect) {
        Registry.register(Registries.BLOCK, MoreOres.id(name),block);
        return Registry.register(Registries.ITEM, MoreOres.id(name),
                new ToxicBlockItem(block, ModItems.normalSettings(name), effect, 10)).getBlock();
    }

    private static Block registerAlcalineBlocks(String name, Block block) {
        Registry.register(Registries.BLOCK, MoreOres.id(name),block);
        return Registry.register(Registries.ITEM, MoreOres.id(name),
                new AlcalineBlockItem(block, ModItems.normalSettings(name))).getBlock();
    }

    private static Block registerOtherWorldBlocks(String name, Block block) {
        Registry.register(Registries.BLOCK, MoreOres.id(name),block);
        return Registry.register(Registries.ITEM, MoreOres.id(name),
                new BlockItem(block, ModItems.normalSettings(name).fireproof())).getBlock();
    }
