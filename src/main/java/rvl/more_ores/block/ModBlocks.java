     ...
     public static void registerModBlocks() {
        ...
        //Plomb Blocks
         DEEPSLATE_PLOMB_ORE = registerBlocks("deepslate_plomb_ore",
                new XpDropToxicBlock(UniformIntProvider.create(2, 4), AbstractBlock.Settings.copy(Blocks.STONE).strength(2.0f).requiresTool(), effect2));
        ...
        //Other Ores
         ...
         DEEPSLATE_ARSENIC_ORE = registerBlocks("deepslate_arsenic_ore",
                new XpDropToxicBlock(UniformIntProvider.create(2, 4), AbstractBlock.Settings.copy(Blocks.STONE).strength(2.0f).requiresTool(), effect1));
