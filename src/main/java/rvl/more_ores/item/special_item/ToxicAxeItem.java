...
import rvl.more_ores.item.Fixer.FixAxeItem;
...
public class ToxicAxeItem extends FixAxeItem {
    ...
    public ToxicAxeItem(FixToolMaterial material, float attackDamage, float attackSpeed, Settings settings, StatusEffect hitEffect) {
