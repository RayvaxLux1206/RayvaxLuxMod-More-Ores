...
import rvl.more_ores.item.tool_fixer.FixShovelItem;
...
public class ToxicShovelItem extends FixShovelItem {
    ...
    public ToxicShovelItem(FixerSettings toolMaterial, float damage, float speed, Settings settings, RegistryEntry<StatusEffect> hitEffect) {
