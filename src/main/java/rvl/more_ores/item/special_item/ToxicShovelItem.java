...
public class ToxicShovelItem extends ShovelItem {

    private final RegistryEntry<StatusEffect> hitEffect;


    public ToxicShovelItem(ToolMaterial toolMaterial, Settings settings, RegistryEntry<StatusEffect> hitEffect) {
