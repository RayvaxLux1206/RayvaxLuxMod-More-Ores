...
public class ToxicMaterialArmorItem extends ArmorItem {
    ...
    public ToxicMaterialArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings, RegistryEntry<StatusEffect> targetEffect, int damageRangeOnHealh) {
