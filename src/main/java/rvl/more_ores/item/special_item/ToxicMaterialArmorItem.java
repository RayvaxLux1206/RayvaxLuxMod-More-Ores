...
public class ToxicMaterialArmorItem extends ArmorItem {
    ...
    public ToxicMaterialArmorItem(ArmorMaterial material, EquipmentType type, Settings settings, RegistryEntry<StatusEffect> targetEffect, int damageRangeOnHealh) {
