...
public class ToxicAnimalArmorItem extends AnimalArmorItem {

    private final int damageRangeOnHealh;
    private final RegistryEntry<StatusEffect> targetEffect;
    public ToxicAnimalArmorItem(RegistryEntry<ArmorMaterial> material, Type type, boolean hasOverlay, Settings settings, RegistryEntry<StatusEffect> targetEffect, int damageRangeOnHealh) {
