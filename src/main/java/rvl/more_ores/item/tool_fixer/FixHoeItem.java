...
public class FixHoeItem extends SimplifyItem {

    protected static final Map<Block, Pair<Predicate<ItemUsageContext>, Consumer<ItemUsageContext>>> TILLING_ACTIONS;

    public FixHoeItem(FixerSettings fix, float attackDamage, float attackSpeed, Settings settings) {
        super(fix.applyToolSettings(settings, BlockTags.HOE_MINEABLE, attackDamage, attackSpeed, 0));
    }
