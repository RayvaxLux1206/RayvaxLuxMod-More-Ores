...
public class FixShovelItem extends FixTool {
    protected static final Map<Block, BlockState> PATH_STATES;

    public FixShovelItem(FixerSettings fix, float attackDamage, float attackSpeed, Item.Settings settings) {
        super(fix, BlockTags.SHOVEL_MINEABLE, attackDamage, attackSpeed, settings);
    }
