...
public class FixShovelItem extends SimplifyItem {
    protected static final Map<Block, BlockState> PATH_STATES;

    public FixShovelItem(FixerSettings fix, float attackDamage, float attackSpeed, Settings settings) {
        super(fix.applyToolSettings(settings, BlockTags.SHOVEL_MINEABLE, attackDamage, attackSpeed, 0));
    }
