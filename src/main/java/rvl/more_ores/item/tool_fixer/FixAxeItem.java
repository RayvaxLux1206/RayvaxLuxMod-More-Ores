...
public class FixAxeItem extends Item {
    public FixAxeItem(FixerSettings fix, float attackDamage, float attackSpeed, Settings settings) {
        super(fix.applyToolSettings(settings, BlockTags.AXE_MINEABLE, attackDamage, attackSpeed, 5) );
    }
