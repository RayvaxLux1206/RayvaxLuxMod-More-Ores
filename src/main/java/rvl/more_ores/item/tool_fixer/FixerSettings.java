...
public class FixerSettings {
    ...
    public Item.Settings tool(Item.Settings settings, TagKey<Block> effectiveBlocks, float attackDamage, float attackSpeed, float disableBlockingForSeconds) {
    ...
    public Item.Settings axe(float attackDamage, float attackSpeed, Item.Settings settings) {
        return this.tool(settings, BlockTags.AXE_MINEABLE, attackDamage, attackSpeed, 5f);
    }

    public Item.Settings shovel(float attackDamage, float attackSpeed, Item.Settings settings) {
        return this.tool(settings, BlockTags.SHOVEL_MINEABLE, attackDamage, attackSpeed, 0f);
    }

    public Item.Settings hoe(float attackDamage, float attackSpeed, Item.Settings settings) {
        return this.tool(settings, BlockTags.HOE_MINEABLE, attackDamage, attackSpeed, 0f);
    }

    public Item.Settings pickaxe(float attackDamage, float attackSpeed, Item.Settings settings) {
        return this.tool(settings, BlockTags.PICKAXE_MINEABLE, attackDamage, attackSpeed, 0f);
    }
