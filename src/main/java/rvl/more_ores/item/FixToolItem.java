...
public class FixToolItem extends Item {
    private final FixToolMaterial material;
    ...
    public FixToolItem(FixToolMaterial material, float attackDamage, float attackSpeed, TagKey<Block> effectiveBlocks, Settings settings) {
    ...
    public FixToolMaterial getMaterial() {
