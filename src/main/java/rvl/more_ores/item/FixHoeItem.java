...
extends FixToolItem {
     ...
     */
    protected static final Map<Block, Pair<Predicate<ItemUsageContext>, Consumer<ItemUsageContext>>> TILLING_ACTIONS = Maps.newHashMap(ImmutableMap.of(Blocks.GRASS_BLOCK, Pair.of(FixHoeItem::canTillFarmland, FixHoeItem.createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.DIRT_PATH, Pair.of(FixHoeItem::canTillFarmland, FixHoeItem.createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.DIRT, Pair.of(FixHoeItem::canTillFarmland, FixHoeItem.createTillAction(Blocks.FARMLAND.getDefaultState())), Blocks.COARSE_DIRT, Pair.of(FixHoeItem::canTillFarmland, FixHoeItem.createTillAction(Blocks.DIRT.getDefaultState())), Blocks.ROOTED_DIRT, Pair.of(itemUsageContext -> true, FixHoeItem.createTillAndDropAction(Blocks.DIRT.getDefaultState(), Items.HANGING_ROOTS))));
    private final TagKey<Block> effectiveBlocks;

    public FixHoeItem(FixToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
