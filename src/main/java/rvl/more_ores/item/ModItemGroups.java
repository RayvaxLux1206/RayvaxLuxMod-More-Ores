...
public class ModItemGroups {
    ...
    public static void registerItemGroups() {
        OVERWORLD_ORES = Registry.register(Registries.ITEM_GROUP,MoreOres.id("overworld_ores"), FabricItemGroup.builder()
                .displayName(Text.translatable("itemgroup.overworld_ores")).icon(() -> new ItemStack(ModItems.ALUMINIUM_INGOT)).entries((displayContext, entries) -> {
                    ...
                    //Toxic BRONZE
                    entries.add(ModItems.TOXIC_BRONZE_INGOT);
                    entries.add(ModItems.TOXIC_BRONZE_NUGGET);
                    entries.add(ModItems.TOXIC_BRONZE_ALLOY);

                    entries.add(ModBlocks.TOXIC_BRONZE_BLOCK);
                    entries.add(ModBlocks.ALLOY_TOXIC_BRONZE_BLOCK);

                    //CHROME
                    entries.add(ModItems.CHROME_INGOT);
                    entries.add(ModItems.CHROME_NUGGET);
                    ...
                    entries.add(ModItems.PLOMB_NUGGET);
                    ...
                    entries.add(ModItems.SODIUM_NUGGET);
        ...
        MORE_ORES_EQUIPEMENT = Registry.register(Registries.ITEM_GROUP, MoreOres.id("more-ores_equipement"), FabricItemGroup.builder()
                .displayName(Text.translatable("itemgroup.more-ores_equipement")).icon(() -> new ItemStack(ModItems.BRONZE_SWORD)).entries((displayContext, entries) -> {
                    ...
                    //Toxic BRONZE
                    entries.add(ModItems.TOXIC_BRONZE_HELMET);
                    entries.add(ModItems.TOXIC_BRONZE_CHESTPLATE);
                    entries.add(ModItems.TOXIC_BRONZE_LEGGINGS);
                    entries.add(ModItems.TOXIC_BRONZE_BOOTS);

                    entries.add(ModItems.TOXIC_BRONZE_PICKAXE);
                    entries.add(ModItems.TOXIC_BRONZE_SHOVEL);
                    entries.add(ModItems.TOXIC_BRONZE_AXE);
                    entries.add(ModItems.TOXIC_BRONZE_HOE);
                    entries.add(ModItems.TOXIC_BRONZE_SWORD);
                    ...
                    //Spears
                    entries.add(ModItems.ALUMINIUM_SPEAR);
                    entries.add(ModItems.TIN_SPEAR);
                    entries.add(ModItems.BRONZE_SPEAR);
                    entries.add(ModItems.TOXIC_BRONZE_SPEAR);
                    entries.add(ModItems.STEEL_SPEAR);
                    entries.add(ModItems.CHROME_SPEAR);
                    entries.add(ModItems.NICKEL_SPEAR);
                    entries.add(ModItems.PLOMB_SPEAR);
                    entries.add(ModItems.SILVER_SPEAR);
                    entries.add(ModItems.TITANIUM_SPEAR);
                    entries.add(ModItems.ZINC_SPEAR);
                    entries.add(ModItems.VOLCANITE_SPEAR);
                    entries.add(ModItems.SOULRITE_SPEAR);
                    entries.add(ModItems.RACKNITE_SPEAR);
                    ...
                    entries.add(ModItems.TOXIC_BRONZE_HORSE_ARMOR);
                    entries.add(ModItems.STEEL_HORSE_ARMOR);
                    entries.add(ModItems.CHROME_HORSE_ARMOR);
                    entries.add(ModItems.NICKEL_HORSE_ARMOR);
                    entries.add(ModItems.PLOMB_HORSE_ARMOR);
                    entries.add(ModItems.SILVER_HORSE_ARMOR);
                    entries.add(ModItems.TITANIUM_HORSE_ARMOR);
                    entries.add(ModItems.ZINC_HORSE_ARMOR);
                    entries.add(ModItems.VOLCANITE_HORSE_ARMOR);
                    entries.add(ModItems.SOULRITE_HORSE_ARMOR);
                    entries.add(ModItems.RACKNITE_HORSE_ARMOR);
                    entries.add(ModItems.ENDERITE_HORSE_ARMOR);

                    //Nautilus Armors
                    entries.add(ModItems.ALUMINIUM_NAUTILUS_ARMOR);
                    entries.add(ModItems.TIN_NAUTILUS_ARMOR);
                    entries.add(ModItems.BRONZE_NAUTILUS_ARMOR);
                    entries.add(ModItems.TOXIC_BRONZE_NAUTILUS_ARMOR);
                    entries.add(ModItems.STEEL_NAUTILUS_ARMOR);
                    entries.add(ModItems.CHROME_NAUTILUS_ARMOR);
                    entries.add(ModItems.NICKEL_NAUTILUS_ARMOR);
                    entries.add(ModItems.PLOMB_NAUTILUS_ARMOR);
                    entries.add(ModItems.SILVER_NAUTILUS_ARMOR);
                    entries.add(ModItems.TITANIUM_NAUTILUS_ARMOR);
                    entries.add(ModItems.ZINC_NAUTILUS_ARMOR);
                    entries.add(ModItems.VOLCANITE_NAUTILUS_ARMOR);
                    entries.add(ModItems.SOULRITE_NAUTILUS_ARMOR);
                    entries.add(ModItems.RACKNITE_NAUTILUS_ARMOR);
                    entries.add(ModItems.ENDERITE_NAUTILUS_ARMOR);



                }).build());

        OTHERWORLD_ORES = Registry.register(Registries.ITEM_GROUP, MoreOres.id("otherworld_ores"), FabricItemGroup.builder()
                .displayName(Text.translatable("itemgroup.otherworld_ores")).icon(() -> new ItemStack(Blocks.NETHERRACK)).entries((displayContext, entries) -> {
                    ...
                    entries.add(ModItems.VOLCANITE_NUGGET);
                    ...
                    entries.add(ModItems.SOULRITE_NUGGET);
                    ...
                    entries.add(ModItems.RACKNITE_NUGGET);
