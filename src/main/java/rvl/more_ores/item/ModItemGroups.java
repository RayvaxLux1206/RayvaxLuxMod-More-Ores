...
public class ModItemGroups {
    ...
    public static void registerItemGroups() {
        OVERWORLD_ORES = Registry.register(Registries.ITEM_GROUP,Identifier.of(MoreOres.MODID,"overworld_ores"), FabricItemGroup.builder()
        ...
        MORE_ORES_EQUIPEMENT = Registry.register(Registries.ITEM_GROUP, Identifier.of(MoreOres.MODID,"more-ores_equipement"), FabricItemGroup.builder()
        ...
        OTHERWORLD_ORES = Registry.register(Registries.ITEM_GROUP, Identifier.of(MoreOres.MODID,"otherworld_ores"), FabricItemGroup.builder()
