...
public class ModItems {
    ...
    private static final RegistryEntry<StatusEffect> effect1 = StatusEffects.POISON;
    private static final RegistryEntry<StatusEffect> effect2 = StatusEffects.WITHER;
     ...
     public static void registerModItems() {
        //Items register - Minerals
         ...
         PLOMB_INGOT = registerItem("plomb_ingot", new ToxicMaterialItem(new Item.Settings(), effect2, 10));
         PLOMB_NUGGET = registerItem("plomb_nugget", new ToxicMaterialItem(new Item.Settings(), effect2, 10));
         PLOMB_RAW = registerItem("plomb_raw", new ToxicMaterialItem(new Item.Settings(), effect2, 10));
        ...
        //ModArmorItems - Plomb Armor
         PLOMB_HELMET = registerItem("plomb_helmet",
                new ToxicMaterialArmorItem(ModArmorMaterials.PLOMB, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(7)), effect2, 10));

         PLOMB_CHESTPLATE = registerItem("plomb_chestplate",
                new ToxicMaterialArmorItem(ModArmorMaterials.PLOMB, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(7)), effect2, 10));

         PLOMB_LEGGINGS = registerItem("plomb_leggings",
                new ToxicMaterialArmorItem(ModArmorMaterials.PLOMB, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(7)), effect2, 10));

         PLOMB_BOOTS = registerItem("plomb_boots",
                new ToxicMaterialArmorItem(ModArmorMaterials.PLOMB, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(7)), effect2, 10));
        ...
        //ModItemTools - Plomb Tools
         PLOMB_PICKAXE = registerItem("plomb_pickaxe",
                new ToxicPickaxeItem(ModToolMaterials.PLOMB, new Item.Settings().attributeModifiers(createAttributeModifiers(3.2f, 1.2f)), effect2));

         PLOMB_SHOVEL = registerItem("plomb_shovel",
                new ToxicShovelItem(ModToolMaterials.PLOMB, new Item.Settings().attributeModifiers(createAttributeModifiers(4.5f, 0.8f)), effect2));

         PLOMB_AXE = registerItem("plomb_axe",
                new ToxicHoeItem(ModToolMaterials.PLOMB, new Item.Settings().attributeModifiers(createAttributeModifiers(9f, 0.7f)), effect2));

         PLOMB_HOE = registerItem("plomb_hoe",
                new ToxicHoeItem(ModToolMaterials.PLOMB, new Item.Settings().attributeModifiers(createAttributeModifiers(1f, 2.6f)), effect2));

         PLOMB_SWORD = registerItem("plomb_sword",
                new ToxicSwordItem(ModToolMaterials.PLOMB, new Item.Settings().attributeModifiers(createAttributeModifiers(6f, 1.2f)), effect2));
        ...
        //ModItemTools - Zinc Tools
         ...
         TOXIC_BRONZE_HELMET = registerItem("toxic_bronze_helmet", new ToxicMaterialArmorItem(ModArmorMaterials.TOXIC_BRONZE, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(11)), effect1, 10));
         TOXIC_BRONZE_CHESTPLATE = registerItem("toxic_bronze_chestplate", new ToxicMaterialArmorItem(ModArmorMaterials.TOXIC_BRONZE, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(11)), effect1, 10));
         TOXIC_BRONZE_LEGGINGS = registerItem("toxic_bronze_leggings", new ToxicMaterialArmorItem(ModArmorMaterials.TOXIC_BRONZE, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(11)), effect1, 10));
         TOXIC_BRONZE_BOOTS = registerItem("toxic_bronze_boots", new ToxicMaterialArmorItem(ModArmorMaterials.TOXIC_BRONZE, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(11)), effect1, 10));

         TOXIC_BRONZE_PICKAXE = registerItem("toxic_bronze_pickaxe", new ToxicPickaxeItem(ModToolMaterials.BRONZE, new Item.Settings().attributeModifiers(createAttributeModifiers(5.5f, 1.2f)), effect1));
         TOXIC_BRONZE_SHOVEL = registerItem("toxic_bronze_shovel", new ToxicShovelItem(ModToolMaterials.BRONZE, new Item.Settings().attributeModifiers(createAttributeModifiers(6f, 1f)), effect1));
         TOXIC_BRONZE_AXE = registerItem("toxic_bronze_axe", new ToxicAxeItem(ModToolMaterials.BRONZE, new Item.Settings().attributeModifiers(createAttributeModifiers(10, 1)), effect1));
         TOXIC_BRONZE_HOE = registerItem("toxic_bronze_hoe", new ToxicHoeItem(ModToolMaterials.BRONZE, new Item.Settings().attributeModifiers(createAttributeModifiers(1, 5)), effect1));
         TOXIC_BRONZE_SWORD = registerItem("toxic_bronze_sword", new ToxicSwordItem(ModToolMaterials.BRONZE, new Item.Settings().attributeModifiers(createAttributeModifiers(7.6f, 1.6f)), effect1));



         ALUMINIUM_HORSE_ARMOR = registerItem("aluminium_horse_armor", new AnimalArmorItem(ModArmorMaterials.ALUMINIUM, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         TIN_HORSE_ARMOR = registerItem("tin_horse_armor", new AnimalArmorItem(ModArmorMaterials.TIN, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         BRONZE_HORSE_ARMOR = registerItem("bronze_horse_armor", new AnimalArmorItem(ModArmorMaterials.BRONZE, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         TOXIC_BRONZE_HORSE_ARMOR = registerItem("toxic_bronze_horse_armor", new ToxicAnimalArmorItem(ModArmorMaterials.TOXIC_BRONZE, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1), effect1, 10));
         STEEL_HORSE_ARMOR = registerItem("steel_horse_armor", new AnimalArmorItem(ModArmorMaterials.STEEL, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         CHROME_HORSE_ARMOR = registerItem("chrome_horse_armor", new AnimalArmorItem(ModArmorMaterials.CHROME, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         NICKEL_HORSE_ARMOR = registerItem("nickel_horse_armor", new AnimalArmorItem(ModArmorMaterials.NICKEL, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         PLOMB_HORSE_ARMOR = registerItem("plomb_horse_armor", new ToxicAnimalArmorItem(ModArmorMaterials.PLOMB, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1), effect2, 10));
         SILVER_HORSE_ARMOR = registerItem("silver_horse_armor", new AnimalArmorItem(ModArmorMaterials.SILVER, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         TITANIUM_HORSE_ARMOR = registerItem("titanium_horse_armor", new AnimalArmorItem(ModArmorMaterials.TITANIUM, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         ZINC_HORSE_ARMOR = registerItem("zinc_horse_armor", new AnimalArmorItem(ModArmorMaterials.ZINC, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         VOLCANITE_HORSE_ARMOR = registerItem("volcanite_horse_armor", new AnimalArmorItem(ModArmorMaterials.VOLCANITE, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         SOULRITE_HORSE_ARMOR = registerItem("soulrite_horse_armor", new AnimalArmorItem(ModArmorMaterials.SOULRITE, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         RACKNITE_HORSE_ARMOR = registerItem("racknite_horse_armor", new AnimalArmorItem(ModArmorMaterials.RACKNITE, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));
         ENDERITE_HORSE_ARMOR = registerItem("enderite_horse_armor", new AnimalArmorItem(ModArmorMaterials.ENDERITE, AnimalArmorItem.Type.EQUESTRIAN, false, new Item.Settings().maxCount(1)));



    }
    private static Item registerItem(String id, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(MoreOres.MODID, id), item);
    }

    public static AttributeModifiersComponent createAttributeModifiers(float baseAttackDamage, float attackSpeed) {
        return AttributeModifiersComponent.builder().add(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(Item.ATTACK_DAMAGE_MODIFIER_ID, "Tool modifier", (double)(baseAttackDamage -1), EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.MAINHAND).add(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(Item.ATTACK_SPEED_MODIFIER_ID, "Tool modifier", (double)attackSpeed-4, EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.MAINHAND).build();
    }
}
