...
//Items register - Minerals
    ...
    public static final Item PLOMB_INGOT = registerItem("plomb_ingot", new ToxicMaterialItem(normalSettings("plomb_ingot").trimMaterial(AddTrimMaterials.TRIM_PLOMB), StatusEffects.WITHER, 10));
    ...
    public static final Item PLOMB_HELMET = registerItem("plomb_helmet",
            new ToxicMaterialItem(humainArmorSettings(ModArmorMaterials.PLOMB, EquipmentType.HELMET, "plomb_helmet"), StatusEffects.WITHER, 10));

    public static final Item PLOMB_CHESTPLATE = registerItem("plomb_chestplate",
            new ToxicMaterialItem(humainArmorSettings(ModArmorMaterials.PLOMB, EquipmentType.CHESTPLATE, "plomb_chestplate"), StatusEffects.WITHER, 10));

    public static final Item PLOMB_LEGGINGS = registerItem("plomb_leggings",
            new ToxicMaterialItem(humainArmorSettings(ModArmorMaterials.PLOMB, EquipmentType.LEGGINGS, "plomb_leggings"), StatusEffects.WITHER, 10));

    public static final Item PLOMB_BOOTS = registerItem("plomb_boots",
            new ToxicMaterialItem(humainArmorSettings(ModArmorMaterials.PLOMB, EquipmentType.BOOTS, "plomb_boots"), StatusEffects.WITHER, 10));
    ...
    //autre minerais
    public static final Item LITHIUM_INGOT = registerItem("lithium_ingot", new AlcalineItem(normalSettings("lithium_ingot").trimMaterial(AddTrimMaterials.TRIM_LITHIUM)));
    ...
    public static final Item ARSENIC = registerItem("arsenic", new ToxicMaterialItem(normalSettings("arsenic").trimMaterial(AddTrimMaterials.TRIM_ARSENIC), StatusEffects.POISON, 10));

    public static final Item SODIUM_INGOT = registerItem("sodium_ingot", new AlcalineItem(normalSettings("sodium_ingot").trimMaterial(AddTrimMaterials.TRIM_SODIUM)));
    ...
    //Toxic_Bronze
    public static final Item TOXIC_BRONZE_INGOT = registerItem("toxic_bronze_ingot", new ToxicMaterialItem(normalSettings("toxic_bronze_ingot").trimMaterial(AddTrimMaterials.TRIM_TOXIC_BRONZE), StatusEffects.POISON, 10));
    ...
    public static final Item TOXIC_BRONZE_HELMET = registerItem("toxic_bronze_helmet", new ToxicMaterialItem(humainArmorSettings(ModArmorMaterials.TOXIC_BRONZE, EquipmentType.HELMET, "toxic_bronze_helmet"), StatusEffects.POISON, 10));
    public static final Item TOXIC_BRONZE_CHESTPLATE = registerItem("toxic_bronze_chestplate", new ToxicMaterialItem(humainArmorSettings(ModArmorMaterials.TOXIC_BRONZE, EquipmentType.CHESTPLATE, "toxic_bronze_chestplate"), StatusEffects.POISON, 10));
    public static final Item TOXIC_BRONZE_LEGGINGS = registerItem("toxic_bronze_leggings", new ToxicMaterialItem(humainArmorSettings(ModArmorMaterials.TOXIC_BRONZE, EquipmentType.LEGGINGS, "toxic_bronze_leggings"), StatusEffects.POISON, 10));
    public static final Item TOXIC_BRONZE_BOOTS = registerItem("toxic_bronze_boots", new ToxicMaterialItem(humainArmorSettings(ModArmorMaterials.TOXIC_BRONZE, EquipmentType.BOOTS, "toxic_bronze_boots"), StatusEffects.POISON, 10));
    ...
    public static final Item TOXIC_BRONZE_HORSE_ARMOR = registerItem("toxic_bronze_horse_armor", new ToxicMaterialItem(horseArmorSettings("toxic_bronze_horse_armor", ModArmorMaterials.TOXIC_BRONZE), StatusEffects.POISON, 10));
    ...
    public static final Item PLOMB_HORSE_ARMOR = registerItem("plomb_horse_armor", new ToxicMaterialItem(horseArmorSettings("plomb_horse_armor", ModArmorMaterials.PLOMB), StatusEffects.WITHER, 10));
