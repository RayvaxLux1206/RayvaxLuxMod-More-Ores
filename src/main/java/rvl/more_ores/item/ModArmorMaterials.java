...
public class ModArmorMaterials {
    ...
    public static final RegistryEntry<ArmorMaterial> TOXIC_BRONZE;
    ...
    private static RegistryEntry<ArmorMaterial> register(String id, EnumMap<ArmorItem.Type, Integer> defense, int enchantability, RegistryEntry<SoundEvent> equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        List<ArmorMaterial.Layer> list = List.of(new ArmorMaterial.Layer(new Identifier(MoreOres.MODID, id)));
    ...
    static {
        ...
        TOXIC_BRONZE = register("toxic_bronze", Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
            map.put(ArmorItem.Type.BOOTS, 2);
            map.put(ArmorItem.Type.LEGGINGS, 4);
            map.put(ArmorItem.Type.CHESTPLATE, 5);
            map.put(ArmorItem.Type.HELMET, 2);
            ...
            return Ingredient.ofItems(ModItems.TOXIC_BRONZE_INGOT);
        });
